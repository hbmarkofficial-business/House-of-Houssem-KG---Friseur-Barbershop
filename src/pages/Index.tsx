  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Braunschweig | House of Houssem KG</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop House of Houssem KG in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="House of Houssem KG | Premium Barbershop Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="House of Houssem KG | Premium Barbershop Braunschweig" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/houseofhoussem",
              "https://www.instagram.com/houseofhoussem"
            ]
          })}
        </script>
      </Helmet>
